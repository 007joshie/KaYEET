...
class QuizGUI: # The entire programs main class
    ...
    def selectQuiz(self,other):
        ...
        try:
            self.filename=str(self.browseQuiz.get(self.browseQuiz.curselection())+".YEET")
        except:
            pass
        
        self.meta= (json.load(open(str(self.browseQuiz.get(self.browseQuiz.curselection())+".YEET"))))
    ...
    def fileExplore(self):
        ...
        self.filename = filedialog.askopenfilename(initialdir = os.getcwd(),title = "Select KaYEET Quiz file",filetypes = [("KaYEET Quiz Files","*.YEET")])
