...
class GUI:
    def __init__(self, root):
        ...
        mainarea.grid_columnconfigure(2, weight=1)

        self.choiceOne = Button(mainarea, text="Choice 1",relief="groove", bg="white", fg="#306bff", width=12, highlightcolor="red", font=('Roboto', '12'))
        self.choiceOne.grid(row=2,column=0,sticky="W",padx=50, pady=50)

        self.choiceTwo = Button(mainarea, text="Choice 2",relief="groove", bg="white", fg="#306bff", width=12, highlightcolor="red", font=('Roboto', '12'))
        self.choiceTwo.grid(row=2,column=1,sticky="W",padx=50, pady=50)

        self.choiceThree = Button(mainarea, text="Choice 3",relief="groove", bg="white", fg="#306bff", width=12, highlightcolor="red", font=('Roboto', '12'))
        self.choiceThree.grid(row=4,column=0,sticky="W",padx=50, pady=50)

        self.choiceFour = Button(mainarea, text="Choice 4",relief="groove", bg="white", fg="#306bff", width=12, highlightcolor="red", font=('Roboto', '12'))
        self.choiceFour.grid(row=4,column=1,sticky="W",padx=50, pady=50)
