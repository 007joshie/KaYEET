...
class Homescreen:
    def __init__(self, master):
        ...
        self.button2 = tk.Button(self.master, text = 'Open', command = self.fileExplore,relief="flat", bg="#c01733",fg="white",width=self.buttonWidth,height=self.buttonHeight,font=self.buttonFont)
    ...
    def fileExplore(self):
        self.filename =   filedialog.askopenfilename(initialdir = os.getcwd(),title = "Select file",filetypes = (("jpeg files","*.jpg"),("all files","*.*")))
        print (self.filename)
