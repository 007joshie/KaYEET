...
class Homescreen:
    ...
    def drawUI(self):
        ...
        self.master.grid_rowconfigure(2, weight=1,uniform="yes")
        self.master.grid_rowconfigure(3, weight=1,uniform="yes")
        ...
        #for i in range(1,20):
        self.browseQuiz.insert(END,"Not Avaliable")
        self.browseQuiz.bind('<<ListboxSelect>>', self.select)
        #self.sidelist.curselection()
