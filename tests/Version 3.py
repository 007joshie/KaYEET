...
class GUI:
    ...
    def __init__(self, root):
        ...
        # sidebar
        self.root=root
        sidebar = tk.Frame(root, width=200, bg='#F0F0F0', height=500, relief='sunken', borderwidth=0)
        ...
        self.mainarea = tk.Frame(root, background='#F0F0F0', width=500, height=500)
        self.mainarea.pack(expand=True, fill='both', side='right')

        self.errortitlevar= StringVar(self.root)
        self.errortitle = Label(self.mainarea, textvar=self.errortitlevar, bg="#F0F0F0", fg="black",font=('Helvetica Neue',18),wraplength=700,pady=5)
        self.errortitle.grid(row=0,column=0,sticky="we",columnspan=4)


        maintitle = Label(self.mainarea, textvar=self.titlevar, bg="#F0F0F0", fg="black",font=('Helvetica Neue',18),wraplength=700,pady=10)
